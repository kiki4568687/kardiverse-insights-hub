    ...
    <div className="space-y-6 animate-in fade-in duration-500">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-foreground">{realTimeData.totalScans.toLocaleString()}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-foreground">{realTimeData.uniqueUsers.toLocaleString()}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-foreground">{realTimeData.dailyAverage.toLocaleString()}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-foreground">Nairobi CBD</p>
      ...
      <Tabs defaultValue="metrics" className="w-full">
        ...
        <TabsContent value="scans" className="space-y-4">
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-lg">Scan Analytics</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
